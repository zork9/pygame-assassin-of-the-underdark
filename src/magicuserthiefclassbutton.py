...
class MagicuserThiefClassButton(MultiClassSelectorButton):
    "MagicuserThief Class Selector Window Button"
    ...
    def cb(self):
	print "MagicuserThief class - Mutliclassselectorbutton clicked !"
