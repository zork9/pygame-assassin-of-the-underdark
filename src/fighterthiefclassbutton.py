...
class FighterThiefClassButton(MultiClassSelectorButton):
    "FighterThief Class Selector Window Button"
    ...
    def cb(self):
	print "FighterThief class - Mutliclassselectorbutton clicked !"
